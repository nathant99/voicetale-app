...
He has been at the circle ever since. He perches on a small wooden perch at the circle's edge. The students see him. *His head rotates 180 degrees at every story's turn.* If the turn lands well, the rotation is *clean and immediate.* If the turn is muddled or absent, Pivot's head *does not rotate at all* — *a real-time signal* that the turn-beat is not working.
