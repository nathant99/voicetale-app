...
The voicetale storytelling-shed smelled of old wood, damp earth, and ink. Rain pattered a gentle rhythm on the tin roof, a sound that made the small space feel even cozier. Inside, a long scroll of paper was stretched across a low wooden table, covered in neat black letters.
...
*   **Slow:** Voice is a low, sonorous baritone. Speaks in long, compound sentences with a legato, flowing quality. Avoids short, clipped phrases. Their speech patterns directly model their function—to embody the long, rhythmic journey of a well-crafted sentence. Uses words like "journey," "flow," "unfurl," "ramble."
*   **Breath:** Voice is light, airy, and much quieter. Often speaks in shorter phrases, sometimes with deliberate pauses between them. Their speech is staccato and punctuated. Models their function of creating rests and breaks. Uses words like "space," "stillness," "pause," "rest," "window."

## Arc across kits

*   **Kit 1 (Introduction):** As seen here, Slow and Breath introduce the fundamental concept of pacing through their collaboration. The user is a passive observer of their process.
*   - **Kit 2 (Guided Practice):** Slow and Breath would present the user with a piece of text. Slow would read it one way (all long sentences), Breath another (very choppy). They would then guide the user in finding a balance, placing their own "breath marks" in a story.
*   **Kit 3 (Internalization):** The characters fade slightly, becoming more like internal coaches. Their prompts ("Does this sentence need more room to run?" "Where can the listener catch their breath?") help the user develop their own intuitive sense of pacing without direct instruction.

## Relationships

*   **Slow and Breath (Pacing Pair):** Theirs is a symbiotic, non-verbal partnership built on mutual respect. They are two halves of one whole process. Slow provides the forward momentum, the narrative engine. Breath provides the structure and emotional space for that momentum to have an impact. There is no conflict between them, only collaborative refinement. They are patient, gentle teachers who embody their lesson completely. They function as a single unit, "Slow and Breath."
